...
if __name__ == '__main__':
    define('url', default='http://127.0.0.1:8000/hub', help="The JupyterHub API URL")
    define('timeout', default=60000, help="The idle timeout (in seconds)")
    define('cull_every', default=60, help="The interval (in seconds) for checking for idle servers to cull")
