...
import sys
sys.path.append('/home/ubuntu/jupyterconfig/GenomeSpaceAuthenticator')
...
#c.Authenticator.whitelist = {'ted', 'ted2', 'mocana'}
c.Authenticator.admin_users = {'ted2', 'ted3'}

c.JupyterHub.proxy_api_ip = '0.0.0.0'
c.JupyterHub.proxy_auth_token = 'd18ed448256042111a910adb8bd3c792'

#import sys
#sys.path.append('/home/tabor/')
#import gpauthenticator
#c.JupyterHub.authenticator_class = gpauthenticator.GenePatternAuthenticator

c.JupyterHub.hub_ip = '0.0.0.0'

c.JupyterHub.extra_log_file = '/home/ubuntu/jupyterconfig/logs/jupyterhub.log'
...
c.DockerSpawner.volumes = {
    ...
    '/home/ubuntu/jupyterconfig/docker_custom':'/opt/conda/lib/python3.5/site-packages/notebook/static/custom',
